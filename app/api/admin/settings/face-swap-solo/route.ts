/**
 * GET / POST /api/admin/settings/face-swap-solo
 *
 * Lê / atualiza `system_settings.face_swap_solo_enabled` (Story 07).
 * Toggle que habilita o pipeline face-swap também em ensaios solo (1 pessoa).
 * Depende de `face_swap_enabled = true` — se o master switch estiver off,
 * o solo também fica off.
 *
...
const KEY = "face_swap_solo_enabled";
